...
Rysunek \ref{fig:erd2} pokazuje tabele algorytmów ML. System wykorzystuje dedykowane tabele do przechowywania wyników rekomendacji trzech zaimplementowanych metod.
...
\textbf{Modele probabilistyczne} -- łańcuch Markowa pierwszego rzędu (predykcja sekwencji zakupowych kategorii) oraz klasyfikator Naive Bayes (prawdopodobieństwo zakupu i churn). System wykorzystuje historię 265 zamówień do budowy macierzy przejść i modeli predykcyjnych.
...
Zmiana metody następuje natychmiast po zapisaniu ustawień i wpływa na wszystkie sekcje rekomendacji w aplikacji. Użytkownik może również wybrać tryb hybrydowy, w którym system wykorzystuje kilka metod równolegle do generowania bardziej zróżnicowanych rekomendacji.
