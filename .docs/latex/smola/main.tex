...
\subsection*{6.2 Content-Based Filtering w praktyce}
\addcontentsline{toc}{subsection}{6.2 Content-Based Filtering w praktyce}

\input{chapter6_ui_cbf.tex}

\subsection*{6.3 Logika rozmyta w praktyce}
\addcontentsline{toc}{subsection}{6.3 Logika rozmyta w praktyce}

\input{chapter6_ui_fuzzy.tex}

\subsection*{6.4 Modele probabilistyczne w praktyce}
\addcontentsline{toc}{subsection}{6.4 Modele probabilistyczne w praktyce}

\input{chapter6_ui_prob.tex}

\subsection*{6.5 Podsumowanie funkcjonowania systemu}
\addcontentsline{toc}{subsection}{6.5 Podsumowanie funkcjonowania systemu}
