...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{fuzzy_price_membership.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{fuzzy_quality_membership.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{fuzzy_popularity_membership.png}
