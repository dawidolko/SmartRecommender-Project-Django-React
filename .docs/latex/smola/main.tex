...
\begin{enumerate}
    \item Żądanie użytkownika trafia do API (\texttt{/api/recommendations/content-based/?product\_id=\{id\}})
...
Panel administracyjny umożliwia dynamiczne przełączanie między metodami rekomendacji wyświetlanymi na stronie głównej aplikacji.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/recomendationSystem.png}
  \caption{Panel wyboru metody rekomendacji.}
