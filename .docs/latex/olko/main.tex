...
\subsection*{4.6 Funkcjonalność "Klienci kupili również"}
\addcontentsline{toc}{subsection}{4.6 Funkcjonalność "Klienci kupili również"}
...
\subsection*{5.5 System cache'owania - Redis}
\addcontentsline{toc}{subsection}{5.5 System cache'owania - Redis}
