...
import { Edit, Trash2, Search, Package, DollarSign, TrendingUp, AlertTriangle, ChevronUp, ChevronDown, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  const handleCreate = async (e) => {
    ...
    try {
      await axios.post(
        ...
        { name, price, old_price: oldPrice, description },
        { headers: { Authorization: `Bearer ${token}` } }
      );
      fetchProducts();
      fetchStats();
