                ...
                {currentSlice.map((cust) =>
                  editId === cust.id ? (
                    ...
                    >
                      ...
                      <td>{cust.role}</td>
                      <td className="action-cell">
                        <button onClick={() => startEdit(cust)} className="btn-edit">
                          <Edit size={18} />
                        </button>
                        <button
            ...
            <div className="pagination-controls">
              ...
              {Array.from({
                ...
                .slice(
                  ...
                  Math.min(Math.ceil(filteredCustomers.length / customersPerPage), currentPage + 2)
                )}
              <button
                onClick={nextPage}
                disabled={
                ...
                className={`pagination-button ${currentPage >= Math.ceil(filteredCustomers.length / customersPerPage) ? "disabled" : ""}`}
              >
