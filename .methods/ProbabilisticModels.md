...
Your current analytics system uses **random number generation** to simulate intelligent behavior. This applies to several key methods in your `analytics.py`:
...
In summary, your system **mimics analytics** using randomness, which is useful for demonstration or testing purposes, but it does **not reflect real data patterns or customer behavior**.
